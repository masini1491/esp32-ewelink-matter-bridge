...
- `C1 CANDIDATE` — ESP32-C6 / Thread capability。Trigger：explicit product requirement 或 architecture decision requiring Thread。Pointers：`docs/build.md`、`docs/roadmap.md`。Persistence does not make this committed work。
